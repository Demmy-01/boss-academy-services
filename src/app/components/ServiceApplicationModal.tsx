...
const PROOF_OF_FUNDS_GROUP_URL = 'https://chat.whatsapp.com/D9atj7EJk2w60PCReq5Yo7?s=cl&p=a&ilr=1';
...
export default function ServiceApplicationModal({
  ...
  useEffect(() => {
    if (isComplete) {
      ...
      // Proof of Funds → WhatsApp group after 3s; others → personal WhatsApp after 4s
  ...
  const handleGroupRedirect = () => {
    window.open(PROOF_OF_FUNDS_GROUP_URL, '_blank');
  };
          ...
          >
            ...
            {currentStep === 'contact' && (
              <div className="space-y-4">
                ...
                {/* Proof-of-Funds group redirect notice */}
                {isProofOfFunds && (
                  <div
                  ...
                  >
                    ...
                    <div>
                      <p className="text-xs font-bold mb-0.5" style={{ color: '#128c7e' }}>⚠️ Important — WhatsApp Group Required</p>
                      <p className="text-xs leading-relaxed" style={{ color: '#2d6a5f' }}>
                        After submitting this form, you will be <strong>automatically redirected</strong> to our exclusive Proof of Funds WhatsApp group. Joining this group is <strong>mandatory</strong> for your application to be processed — you will receive expert guidance, document templates, and direct support there.
                      </p>
                    </div>
                  </div>
                )}
            ...
            {isComplete && (
              <div className="flex flex-col items-center animate-fadeUp overflow-hidden w-full">
                {serviceSlug === 'study-europe' ? (
                  ...
                  /* Proof of Funds — WhatsApp Group Redirect Screen */
                  <div className="w-full flex flex-col items-center">
                    <div
                      className="w-full py-7 px-6 flex flex-col items-center justify-center text-center relative"
                      style={{
                    ...
                    >
                      ...
                      <div
                        className="flex items-center justify-center w-16 h-16 rounded-full bg-white mb-3 shadow-lg relative z-10"
                        style={{ animation: 'pulseWaGlow 2s infinite' }}
                      >
                        <svg viewBox="0 0 24 24" fill="#25D366" className="w-10 h-10">
                          <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" />
                        </svg>
                    ...
                    <div className="w-full px-7 pt-5 pb-7 flex flex-col items-center">
                      <p className="text-sm text-center mb-5" style={{ color: '#6B6760', lineHeight: 1.6, maxWidth: '420px' }}>
                        Your details have been saved. You <strong style={{ color: '#0D1117' }}>must join our WhatsApp group</strong> — it is where you will receive your financial documentation templates, expert guidance, and direct support for your application.
                      </p>

                      {/* Info box */}
                      <div
                        className="w-full p-4 mb-5 rounded-xl text-left"
                        style={{ background: 'rgba(37,211,102,0.06)', border: '1.5px solid rgba(37,211,102,0.2)' }}
                      >
                        <p className="text-xs font-bold mb-2" style={{ color: '#128c7e' }}>What happens in the group?</p>
                        <ul className="space-y-1.5 text-xs" style={{ color: '#2d6a5f' }}>
                          <li className="flex items-start gap-2"><span style={{ color: '#25D366' }}>✓</span> Receive bank statement templates accepted by embassies</li>
                          <li className="flex items-start gap-2"><span style={{ color: '#25D366' }}>✓</span> Get step-by-step guidance from our financial documentation experts</li>
                          <li className="flex items-start gap-2"><span style={{ color: '#25D366' }}>✓</span> Ask questions and get answers in real time</li>
                          <li className="flex items-start gap-2"><span style={{ color: '#25D366' }}>✓</span> Connect with others going through the same process</li>
                        </ul>
                      </div>

                      <button
                        onClick={handleGroupRedirect}
                        className="wa-btn wa-btn-pulse w-full inline-flex items-center justify-center gap-3 px-8 py-4 text-base font-bold rounded-xl cursor-pointer shadow-md text-white"
                      ...
                      <span className="text-[10px] text-gray-400 mt-2">Redirecting automatically in 3 seconds...</span>

                      <button
                        onClick={() => onOpenChange(false)}
                        className="mt-4 text-xs font-medium cursor-pointer py-1.5 px-3 rounded text-gray-400 hover:text-gray-700 hover:bg-gray-100 transition-all"
                      >
                        Close window
                      </button>
                    </div>
